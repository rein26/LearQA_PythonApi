...
class Assertions:
    ...
    @staticmethod
    def assert_response_content(response: Response, actual_text, expected_text, ):
        assert actual_text == expected_text, f"Error in returned content. Response content: {response.text}"
